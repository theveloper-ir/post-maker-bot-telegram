...
class Telegram
{
    ...
    {
        $this->bot_token = $input['bot_token'];
        $this->data = $this->getData();
        $this->log_errors = isset($input['log_errors']) && $input['log_errors']?true:false;
        $this->proxy = isset($input['proxy'])?$input['proxy']:[];
    ...
    {
        return $this->endpoint('ب', $content);
    }
    ...
    /**
     * \return the String forward_from_message_id.
     */
    public function ForwardFromMessageID()
    {
        return $this->data['message']['forward_from_message_id'];
    }
    ...
    /// Get the reply_markup inline_keyboard of the current message

    /**
     * \return the object reply_markup inline_keyboard.
     */
    ...
    /**
     * \return the object message forward_from.
     */
    public function forwardFromData()
    {
        return $this->data['message']['forward_from'];
    }

    /**
     * \return the object message forward_from_chat.
     */
    public function forwardFromChatData()
    {
